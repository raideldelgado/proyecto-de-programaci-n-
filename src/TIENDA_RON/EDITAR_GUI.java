        ...
        if(bebida.getSelectedItem().equals("Cerveza")){
            ...
            for(int i=0;i<GUI_PRINCIPAL.cervezas.size();i++){
                if(GUI_PRINCIPAL.cervezas.get(i).getNombre().equals(nombre.getText())){
                    ...
                    int ganancia = cantidad_aux*precio_venta_aux - cantidad_aux*precio_compra_aux;
                    
                    GUI_PRINCIPAL.cervezas.get(i).setCantidad(cantidad_aux);
                    GUI_PRINCIPAL.cervezas.get(i).setEnvace(envace_aux);
                    GUI_PRINCIPAL.cervezas.get(i).setPrecio_compra(precio_compra_aux);
                    GUI_PRINCIPAL.cervezas.get(i).setPrecio_venta(precio_venta_aux);
                    GUI_PRINCIPAL.cervezas.get(i).setVolumen(volumen);
                    GUI_PRINCIPAL.cervezas.get(i).setGanancia(ganancia);
            ...
            for(int i=0;i<GUI_PRINCIPAL.cervezas.size();i++){
                if(GUI_PRINCIPAL.licores.get(i).getNombre().equals(nombre.getText())){
                    ...
                    GUI_PRINCIPAL.licores.get(i).setCantidad(cantidad_aux);
                    GUI_PRINCIPAL.licores.get(i).setEnvace(envace_aux);
                    GUI_PRINCIPAL.licores.get(i).setPrecio_compra(precio_compra_aux);
                    GUI_PRINCIPAL.licores.get(i).setPrecio_venta(precio_venta_aux);
                    GUI_PRINCIPAL.licores.get(i).setColor(color_aux);
                    GUI_PRINCIPAL.licores.get(i).setGanancia(ganancia);
            ...
            if(band == false){
                ...
                JOptionPane.showMessageDialog(null, "Licor editada correctamente");
                nombre.setText("");
                cantidad.setText("");
                precio_compra.setText("");
                precio_venta.setText("");
            ...
            for(int i=0;i<GUI_PRINCIPAL.rones.size();i++){
                if(GUI_PRINCIPAL.rones.get(i).getNombre().equals(nombre.getText())){
                    ...
                    GUI_PRINCIPAL.rones.get(i).setCantidad(cantidad_aux);
                    GUI_PRINCIPAL.rones.get(i).setEnvace(envace_aux);
                    GUI_PRINCIPAL.rones.get(i).setPrecio_compra(precio_compra_aux);
                    GUI_PRINCIPAL.rones.get(i).setPrecio_venta(precio_venta_aux);
                    GUI_PRINCIPAL.rones.get(i).setTipo(tipo);
                    GUI_PRINCIPAL.rones.get(i).setGanancia(ganancia);
            ...
            if(band == false){
                ...
                JOptionPane.showMessageDialog(null, "Ron editada correctamente");
                nombre.setText("");
                cantidad.setText("");
                precio_compra.setText("");
                precio_venta.setText("");
